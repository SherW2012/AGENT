...
class WebServerTests(unittest.TestCase):
    ...
    def test_static_page_loads(self):
        ...
        self.assertIn('id="workdir-chip"', body)
        self.assertIn('id="web-search-toggle"', body)
        self.assertIn('id="mascot"', body)
        self.assertIn('id="calendar-grid"', body)
        self.assertIn('id="quick-links"', body)
        ...
        self.assertIn('id="web-search-enabled-toggle"', body)
        self.assertNotIn('name="web-search-mode"', body)
        self.assertNotIn('name="search-provider"', body)
        self.assertNotIn('id="preview-content"', body)
